...
//  using get to that one can share and search
app.get('/search', function(req,res)
    {
        // /search?q=text to search for
        // what should I look for? - in this case look for title
        // find anything with string q, and put that in outputTemplate.ejs file
        // regex means regular expression - giving more freedom on search
        console.log("search for: " + req.query.q);
        var query =  new RegExp(req.query.q, 'i');
        db.find({title: query}, function (err, docs)
        {
